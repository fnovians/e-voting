...
<div class="auth-card-wrapper" style="max-width: 460px; margin: auto;">
  <div class="card auth-card">
    ...
    <form action="{{ route('register') }}" method="POST">
      ...
      <div class="mb-3 text-start auth-staggered auth-delay-4">
      ...
      <button type="submit" class="btn auth-btn-primary w-100 py-2.5 auth-staggered auth-delay-5">Daftar Akun Pemilih</button>
    </form>
  </div>
</div>
@endsection
